...
const Footer = () => {
    return (
        <div>
            <footer className="footer p-10 bg-slate-500 rounded-lg  text-white">
                <div>
            ...
            <footer className="footer px-10 py-4 border-t bg-slate-500 rounded-lg text-base-content border-base-300">
                <div className="items-center grid-flow-col text-white">
                    <img src={logo} alt="" />
                    <p>Auto Car Drive. <br />Providing reliable tech since 2002</p>
                </div>
